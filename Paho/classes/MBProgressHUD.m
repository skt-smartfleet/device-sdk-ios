...
// Deprecated
@property (nonatomic, copy, nullable) MBProgressHUDCompletionBlock completionBlock;
...
- (void)commonInit {
    ...
    UIImageView *imgLoadingBg = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, 50, 54)];
    [imgLoadingBg setImage:[UIImage imageNamed:@"loading_bg"]];
    
    _imgLoading = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"loading"]];
    _imgLoading.frame = CGRectMake(9, 12, 31, 31);
    [imgLoadingBg addSubview:_imgLoading];
    
    _customView = imgLoadingBg;
...
- (void)updateIndicators {
    ...
    if (mode == MBProgressHUDModeIndeterminate) {
        ...
        [_imgLoading.layer addAnimation:animation forKey:@"rotate-layer"];
    }
