...
- (void)viewDidLoad {
    ...
    tfToken.text = [AppDelegate loadFromUserDefaults:@"Token"];
...
- (void)textFieldDidEndEditing:(UITextField *)textField{
    ...
    [AppDelegate instance].strToken = tfToken.text;
    ...
    [AppDelegate saveFromUserDefaults:tfToken.text forKey:@"Token"];
